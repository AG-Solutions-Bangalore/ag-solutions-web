...
export const mobileAppServiceData: CommonServicePageProps = {
    ...
    whyTitleMain: "Your Trusted",
    whyTitleHighlight: "App Development Partner",
    whyDescription: "We combine innovation, technology and experience to build mobile apps that make a difference.",
    whyFeatures: [
        {
            title: "Experienced Team",
            description: "Skilled developers with proven expertise in building successful mobile apps.",
            icon: FaUsers,
            bgColor: "bg-teal",
        },
        {
            title: "Innovative Solutions",
            description: "We use the latest technologies to create innovative and future-ready solutions.",
            icon: FaLightbulb,
            bgColor: "bg-pink",
        },
        {
            title: "On-Time Delivery",
            description: "We follow agile practices to deliver your project on time, every time.",
            icon: FaRocket,
            bgColor: "bg-yellow",
        },
        {
            title: "Security First",
            description: "We build secure apps and follow best practices to protect your data.",
            icon: FaShieldHalved,
            bgColor: "bg-green",
        },
        {
            title: "Dedicated Support",
            description: "Our support team is always ready to assist you even after launch.",
            icon: FaHeadset,
            bgColor: "bg-teal",
        },
    ],
