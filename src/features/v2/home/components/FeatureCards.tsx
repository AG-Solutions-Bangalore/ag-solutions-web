                    ...
                    {features.map((feature, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative overflow-hidden flex flex-col items-center justify-between rounded-2xl border border-border bg-card p-6 sm:p-8 text-center shadow-2xs transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-pink/30"
                            >
                                <div className="flex flex-col items-center w-full">
                                    ...
                                    <h3 className="text-lg font-bold text-dark transition-colors duration-200 group-hover:text-pink">{feature.title}</h3>
                                    <p className="mt-2.5 text-sm leading-relaxed text-muted font-normal">
                                        {feature.description}
                                    </p>
                                </div>
