    ...
    <section className="bg-white py-16 md:py-24 lg:py-28">
      <div className="max-w-[1180px] mx-auto px-5 sm:px-8 md:px-12">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-4 sm:gap-5 reveal">
          ...
          <div className="flex-1 min-w-[200px] bg-[#F5F8FC] rounded-[24px] p-7">
            <span className="w-11 h-11 rounded-xl bg-white text-[#1557E8] flex items-center justify-center mb-4 shadow-[0_2px_10px_rgba(7,27,73,0.07)]">
              <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <h3 className="font-['Plus_Jakarta_Sans',sans-serif] text-[1.02rem] font-bold text-[#071B49] mb-1.5">
              Built for Export Workflows
            </h3>
            <p className="text-[0.88rem] text-[#54628A]">
        ...
        <p className="mt-9 text-center text-[0.92rem] text-[#54628A] reveal">
