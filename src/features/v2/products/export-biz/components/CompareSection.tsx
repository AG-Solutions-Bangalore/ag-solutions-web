    ...
    <section className="bg-[#F5F8FC] py-14 md:py-20 lg:py-24">
      <div className="max-w-[1180px] mx-auto px-5 sm:px-8 md:px-12">
        <div className="max-w-[640px] mx-auto text-center mb-11 reveal">
          ...
          <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[#071B49] text-[1.9rem] sm:text-[2.3rem] lg:text-[2.6rem] leading-[1.1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 reveal">
          {/* Before Card */}
          <div className="bg-white border border-[#E3E9F6] rounded-[24px] p-6.5 sm:p-8">
            <div className="flex items-center gap-2 mb-5">
              <span className="w-3 h-3 rounded-full bg-red-400 shrink-0" />
              <div className="font-['Plus_Jakarta_Sans',sans-serif] font-extrabold text-[1.15rem] text-[#54628A]">
                Before Export Biz (Manual Way)
              </div>
            </div>

            <ul className="space-y-3">
              <li className="flex items-center text-[0.94rem] text-[#54628A] bg-[#F5F8FC] p-3 rounded-xl border border-[#E3E9F6]">
          ...
          {/* After Card */}
          <div className="bg-gradient-to-br from-white to-[#EEF4FF] border-1 border-[#1557E8]/30 rounded-[24px] p-6.5 sm:p-8 shadow-[0_14px_34px_rgba(7,27,73,0.01)]">
            <div className="flex items-center gap-2 mb-5">
              <span className="w-3 h-3 rounded-full bg-[#16B86A] shrink-0" />
              <div className="font-['Plus_Jakarta_Sans',sans-serif] font-extrabold text-[1.15rem] text-[#071B49]">
