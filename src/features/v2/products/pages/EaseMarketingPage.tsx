...
export const EaseMarketingPage: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        {(isVisible) => (
          <div className={`${layoutContainerClass} grid grid-cols-1 md:grid-cols-[0.9fr_1.1fr] gap-8 md:gap-12 items-center`}>
            {/* Left Image */}
      ...
      >
        {(isVisible) => (
          <div className={layoutContainerClass}>
            ...
            <div
              className={`mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 home-animated-item ${
      ...
      >
        {(isVisible) => (
          <div className={`${layoutContainerClass} grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12`}>
            ...
            >
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <input type="hidden" name="enquiryFrom" value="Ease Marketing" />
                  <div>
                    <input
                      type="text"
                      required
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6 pt-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                      <button
                        ...
                        className="cursor-pointer rounded-full bg-[#93d034] text-white hover:bg-[#82c024] px-8 sm:px-10 py-3.5 sm:py-4 font-bold text-sm sm:text-[15px] tracking-wider transition-all active:scale-[0.98] shrink-0 disabled:opacity-50 w-full sm:w-auto"
                      >
