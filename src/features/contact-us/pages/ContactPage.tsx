              ...
              >
                {!isSubmitted ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-10 text-center animate-fadeIn">
                    ...
                    <h3 className="text-3xl font-bold md:text-4xl text-[#1b2c38] mb-2">
                      Message Sent!
                    </h3>
                    <p className="text-[#4f5a62] text-lg md:text-xl font-medium">
            ...
            <div className={`${layoutContainerClass} pb-14`}>
              ...
              >
                <SectionTitle
                  title="Get In Touch"
                  align="left"
                  titleClassName="text-[42px] leading-[1.16] font-black tracking-normal text-[#1b2c38] max-[980px]:text-[36px] max-[560px]:text-[28px]"
                />
              </div>
            </div>
