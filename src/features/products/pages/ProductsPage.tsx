              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-5 sm:p-6 pb-2 flex items-center justify-between">
                    ...
                    >
                      {product.iconName === "export" && <FileSpreadsheet className={`h-8 w-8 sm:h-9 sm:w-9 ${product.iconColorClass}`} />}
                      {product.iconName === "bizstock" && <Boxes className={`h-8 w-8 sm:h-9 sm:w-9 ${product.iconColorClass}`} />}
                      {product.iconName === "marketing" && <Megaphone className={`h-8 w-8 sm:h-9 sm:w-9 ${product.iconColorClass}`} />}
                      {product.iconName === "grow" && <Users2 className={`h-8 w-8 sm:h-9 sm:w-9 ${product.iconColorClass}`} />}
                    </div>
