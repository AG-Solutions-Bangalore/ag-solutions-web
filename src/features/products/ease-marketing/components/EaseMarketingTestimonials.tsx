...
const testimonials: Testimonial[] = [
  {
    quote:
      "Ease Marketing has completely simplified our WhatsApp outreach. Our sales and response rate increased significantly!",
    name: "Ravi Sharma",
  ...
  {
    quote:
      "The follow-up and tracking system helps us never miss a lead. It's a must-have tool for any business.",
    name: "Sneha Patel",
    role: "Business Owner",
  ...
  {
    quote:
      "Great platform, amazing support, and powerful features. Highly recommended!",
    name: "Arjun Mehta",
    role: "Growth Manager",
...
export const EaseMarketingTestimonials: React.FC = () => {
            ...
            >
              ...
              <div className="flex items-center gap-3.5 pt-4 border-t border-border/70">
                <div className="h-11 w-11 rounded-full overflow-hidden border-2 border-pink/30 shrink-0 bg-slate-100 dark:bg-slate-800">
                  <img
                    src={item.avatar}
                    alt={`${item.name} - Ease Marketing Customer`}
                    title={`${item.name} - Ease Marketing Customer`}
...
export default EaseMarketingTestimonials;
