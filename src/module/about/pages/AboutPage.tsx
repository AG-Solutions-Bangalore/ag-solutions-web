...
function AboutPage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#0a7df2] py-24 text-center text-white max-[760px]:py-16">
        <div className="absolute inset-0 bg-[url('/images/pattern-bg-blue-light.jpg')] bg-[length:450px_330px] bg-top opacity-[0.22]" />
        <div className="absolute inset-0 bg-[#0a7df2]/40" />
        ...
        {(isVisible) => (
          <div className={`${layoutContainerClass}`}>
            ...
            >
              ...
              <div
                className="about-color-line relative mt-6 h-[3px] w-[220px] overflow-hidden bg-[#1b2c38]"
                aria-hidden="true"
              >
